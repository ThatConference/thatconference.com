<script>
	...
	import Speakers from '$components/events/Speakers.svelte';
	import Membership from '$components/events/MembershipCard.svelte';
	import FAQ from '$components/events/FAQ.svelte';
