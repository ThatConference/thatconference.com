...
<section>
	<div class="prose prose-lg mx-auto text-gray-500">
		...
		<ul>
			...
			<li>
				<strong class="italic">Description: </strong>Here you explain a bit more about the potential
				conversation you're wishing to have. If you're seeking help from others explain what help
				you think you need so others who might have the answer know if they're able to help.
			</li>
			<li>
				<strong class="italic">Tags: </strong>You have a limit of 5 tags. These are attributes about
				this conversation and they help people search for Activities they would like to participate
				in.
			</li>
			<li>
				<strong class="italic">Date and Start Time: </strong>This sets our Activity's start day and
				time (in your timezone). Mind you people from all over the world are joining and you can
				pick anytime throughout the day as to best overlap with different timezones.
			</li>
			<li>
