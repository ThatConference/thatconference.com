...
<div class="prose prose-lg mx-auto text-gray-500">
	...
	<div>
		...
		<ol>
			...
			<li>
				Choose the import method: Depending on your calendar software, you may have different import
				methods available. Here are a few common ones:
				<ol>
					<li>
			...
			<li>
				...
				specific calendar within your account, set a custom name or color for the imported calendar,
				or specify the frequency of updates from the ICS feed.
			</li>
			<li>
				Confirm the import: Once you have provided the necessary information, click the "Import" or
				"Add Calendar" button to initiate the import process. The calendar application will attempt
				to retrieve the events from the ICS feed.
			</li>
			<li>
				Wait for the import to complete: Depending on the size of the calendar and your internet
				connection speed, it may take a few moments for the import process to finish. Be patient and
				allow the application to fetch and populate the events into your calendar.
			</li>
			<li>
				Verify the imported calendar: After the import process completes, navigate to your calendar
				view and check if the imported calendar appears. It may have a distinct color or name based
