...
<section>
	<div
		...
		<p>
			Here at THAT, it's our mission to help foster the best community of geeks on this planet. Our
			vision, create an interactive platform connecting Geeks and Geeklings across the globe in such
			a way they can help one another whenever and wherever regardless of topic or format.
		</p>

		<p class="mt-8">
			We created THAT to fill a gap between the times when we cannot physically connect. We believe
			peer-to-peer learning is one of the most powerful ways we can help one another any day of the
			year.
		</p>
	</div>
	<div
		...
		<div class="relative mb-12 lg:mb-0">
            ...
            text-gray-500 lg:max-w-none">
				...
				<p class="mt-8">
					...
					chat window, you're able to share your desktop, your webcam and mic are enabled. Our goal
					is to create the best virtual face-to-face conversation possible but give you the room to
					have any type of conversation you need. We're grateful you're here and now we want to make
