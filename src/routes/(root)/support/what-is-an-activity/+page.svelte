...
<section>
	<div class="prose prose-lg mx-auto text-gray-500">
		<p>
			...
			with no tools required. Every Activity has a chat window, the ability to share your desktop, and
			enables your webcam and microphone. You choose the format that best suits the topic and the people
			in the conversation.
		</p>
		...
		<p>
			The length of an Activity is up to you. An Activity may be a short 30 minutes or last all day.
			We have seen quick 30-minute issue triage, to an entire weekend hackathon-type activity. It's
			entirely up to you and what you are trying to achieve. In the example above you will see our
