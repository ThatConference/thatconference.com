...
<section>
	<div class="prose prose-lg mx-auto text-gray-500">
		<p>
			...
			5 minutes before the scheduled start time (in your timezone0) and will remain active for the duration
			of the activity. THAT works in any browser and you just need to enable your webcam and microphone.
			We do require everyone to log in before joining any Activity. Your mic will always be muted by
			default and your camera will be enabled. Activities are currently limited to 100 concurrent attendees.
		</p>
		...
		<p>
			We want everyone to be epic and help one another. We've compiled a list of guiding principals:
		</p>
		<ul>
			...
			<li>
				Use care with humor. If you feel the need to use humor during meetings, make sure that it's
				appropriate for your audience. THAT serves a global audience, and sometimes while many speak
				English not everything translates well.
			</li>
