...
<section>
	<div class="prose prose-lg mx-auto text-gray-500">
		<p>
			You've purchased a bunch of tickets, or, unfortunately, are no longer able to attend and need
			to transfer/assign the ticket(s) to someone else. That's no problem, read on to see how to do
			it.
		</p>
		...
		<div class="transform text-center">
			<figure>
				<img class="lazyload" src="/images/order-history-example.jpg" alt="order history example" />
